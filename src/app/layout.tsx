...
export const metadata: Metadata = {
  ...
  description:
    'Premium Automated Gate Pass Management System for VSB Engineering College Boys Hostel-I (New Construction First Floor). Fast room search, instant month-end passes, official A4 PDF/Word generation, and master student registry.',
};
          ...
          <footer className="relative z-10 border-t border-emerald-500/20 bg-[#021813]/90 backdrop-blur-md py-6 text-center text-xs text-emerald-400/60">
            <div className="max-w-7xl mx-auto px-4 flex flex-col sm:flex-row items-center justify-between gap-2">
              ...
              <p className="flex items-center space-x-1.5 font-medium">
                ...
                <span>Permanent Master Registry • 97 Active Hostel Members</span>
              </p>
            </div>
          </footer>
        </div>
